...
#exercício A revisado!

print("Exercicio A : Preposições" )
prep = []
fatec = ['f', 't', 'c']
for palavra in txtB:
        if palavra[0] in fatec and palavra[-1] not in fatec:
                prep.append(palavra)
...
#exercício B revisado!

print("Exercicio B : Verbos")
prep = []
fatec = ['f', 't', 'c']
for palavra in txtB:
        if len(palavra) == 5 and palavra[-1] not in fatec:
                prep.append(palavra)
print(len(prep))
print("***************************\n")

#exercício C revisado!

print("Exercicio C : Verbos em primeira pessoa")
prep = []
fatec = ['f', 't', 'c']
for palavra in txtB:
        if len(palavra) == 5 and palavra[-1] not in fatec and palavra[0] not in fatec:
                prep.append(palavra)
print (len(prep))
print("***************************\n")


#exercício D revisado!

print("Exercicio D : Ordem do Texto \n")
...
alfabeto_fatec = 'ftczmbshjpnwlrxkqvdg'
alfabeto =       'abcdefghijklmnopqrst'


for i in range(len(alfabeto_fatec)) :
        txtB = txtB.replace(alfabeto_fatec[i],alfabeto[i])
        lista = txtB.split()
        ordem = sorted(lista)
        texto_ordenado= ' '.join(ordem)

        for y in range(len(alfabeto)):
                texto_ordenado =  texto_ordenado.replace(alfabeto[y],alfabeto_fatec[y])
                y = y + 1
